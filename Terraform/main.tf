...
provider "azurerm" {
  features {}
  client_id       = "6147eceb-c018-4980-afb4-76b8491bbf01"
  client_secret   = "SJt8Q~ZJlvqjBjeB9rvTYhvub1~Zs9X9C4pEPdbT"
  tenant_id       = ""
  subscription_id = "381cde13-71b9-48af-9880-f65e08809307"
}
